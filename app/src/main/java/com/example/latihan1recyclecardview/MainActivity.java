...
public class MainActivity extends AppCompatActivity {
    ...
    String[] singers = {"Mike Posner", "Lukas Graham", "Zayn Malik", "Fifth Harmony", "Zara Larsson & MNEK", "The Chainsmokers",
                        "Justin Bieber", "G-Easy & Bebe Rexha", "DNCE", "Ariana Grande", "FloRida", "Twenty One Pilots", "Drake",
                        "DJ Snake", "Meghan Trainor"};
